...
public class ConsolaOlimpicos
{
	...
	{
		System.out.println("\n" + "País al que pertenece un atleta" + "\n");
		String atleta = input("Por favor ingrese el nombre del atleta");
		if (atleta != null)
		{
			Map<String, Pais> resultado = calculadora.paisAtleta(atleta);
			if (resultado == null)
			{
				System.out.println("No se encontraron medallistas del atleta ingresado.");
			}
			else
			{
				System.out.println("El país del atleta" + atleta + "es" + resultado.values() );
			}
		}
